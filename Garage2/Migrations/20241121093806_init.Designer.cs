            ...
            modelBuilder.Entity("Garage301.Models.ParkedVehicle", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            ArrivalTime = new DateTime(2024, 11, 21, 8, 38, 5, 467, DateTimeKind.Local).AddTicks(1319),
                            Color = "Blue",
                            Make = "Toyota",
                            Model = "Corolla",
                            NumberOfWheels = 4,
                        ...
                        {
                            Id = 2,
                            ArrivalTime = new DateTime(2024, 11, 21, 8, 38, 5, 467, DateTimeKind.Local).AddTicks(1569),
                            Color = "Green",
                            Make = "Hyundai",
                            Model = "i3",
                            NumberOfWheels = 4,
                        ...
                        {
                            Id = 3,
                            ArrivalTime = new DateTime(2024, 11, 21, 8, 38, 5, 467, DateTimeKind.Local).AddTicks(1573),
                            Color = "Black",
                            Make = "BMW",
                            Model = "M3",
                            NumberOfWheels = 4,
                        ...
                        {
                            Id = 4,
                            ArrivalTime = new DateTime(2024, 11, 21, 8, 38, 5, 467, DateTimeKind.Local).AddTicks(1576),
                            Color = "Red",
                            Make = "Honda",
                            Model = "Goldwing",
                            NumberOfWheels = 2,
                        ...
                        {
                            Id = 5,
                            ArrivalTime = new DateTime(2024, 11, 21, 8, 38, 5, 467, DateTimeKind.Local).AddTicks(1580),
                            Color = "Green",
                            Make = "Yamaha",
                            Model = "R1",
                            NumberOfWheels = 2,
