...
namespace Garage301.Migrations
{
    ...
    [Migration("20241122091501_InitialMigration")]
            ...
            modelBuilder.Entity("Garage301.Models.ParkedVehicle", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ArrivalTime = new DateTime(2024, 11, 22, 8, 14, 59, 337, DateTimeKind.Local).AddTicks(9208),
                            Color = "Blue",
                            Make = "Toyota",
                            Model = "Corolla",
                            NumberOfWheels = 4,
                        ...
                        new
                        {
                            ...
                            ArrivalTime = new DateTime(2024, 11, 22, 8, 14, 59, 337, DateTimeKind.Local).AddTicks(9354),
                            Color = "Green",
                            Make = "Hyundai",
                            Model = "i3",
                            NumberOfWheels = 4,
                        ...
                        new
                        {
                            Id = 3,
                            ApplicationUserId = "user2",
                            ArrivalTime = new DateTime(2024, 11, 22, 8, 14, 59, 337, DateTimeKind.Local).AddTicks(9360),
                            Color = "Black",
                            Make = "BMW",
                            Model = "M3",
                            NumberOfWheels = 4,
                        ...
                        new
                        {
                            Id = 4,
                            ApplicationUserId = "user1",
                            ArrivalTime = new DateTime(2024, 11, 22, 8, 14, 59, 337, DateTimeKind.Local).AddTicks(9365),
                            Color = "Red",
                            Make = "Honda",
                            Model = "Goldwing",
                            NumberOfWheels = 2,
                        ...
                        new
                        {
                            Id = 5,
                            ApplicationUserId = "user2",
                            ArrivalTime = new DateTime(2024, 11, 22, 8, 14, 59, 337, DateTimeKind.Local).AddTicks(9370),
                            Color = "Green",
                            Make = "Yamaha",
                            Model = "R1",
                            NumberOfWheels = 2,
